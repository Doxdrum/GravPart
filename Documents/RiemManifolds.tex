...
One might consider metrics compatible\index{Metric compatibility} with the connection, 
\begin{equation}
...
\end{align}
A form satisfying $\Delta \alpha = 0$ is said to be an \emph{\idx{Harmonic form}}.

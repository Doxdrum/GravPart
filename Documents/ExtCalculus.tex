...
It follows from the definition of the exterior derivative, that the double action of $\df\,$ vanishes, i.e., $\df\,^2=0$. This property is known as \emph{\idx{nilpotency}}.
...
\begin{WEbox}[frametitle={Differential Forms in $\R^3$},
  ...
  \begin{align}
    \df\, f= \frac{\partial f}{\partial x}\de{x} +\frac{\partial f}{\partial y}\de{y} +\frac{\partial f}{\partial z}\de{z},
  \end{align}
  ...
  \begin{align}
    \df\,\omega &= \(\partial_x\omega_y-\partial_y\omega_x\)\de{x}\we\de{y} +\(\partial_y\omega_z-\partial_z\omega_y\)\de{y}\we\de{z}\notag\\
  ...
  \begin{align}
    \df\, \omega = \(\partial_x\omega_{yz}+\partial_y\omega_{zx}+\partial_z\omega_{xy}\)\de{x}\we\de{y}\we \de{z},
  \end{align}
